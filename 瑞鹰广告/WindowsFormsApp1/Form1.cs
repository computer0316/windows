...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Resize(object sender, EventArgs e)
        {
            ...
            label2.Left = label1.Left + 280;

            label3.Top = label1.Top;
            label3.Left = label2.Left + 280;

            label4.Top = label1.Top;
            label4.Left = label3.Left + 280;

            label5.Top = label1.Top;
            label5.Left = label4.Left + 280;


            label6.Top = label1.Top + 160;
            label6.Left = label1.Left;

            label7.Top = label6.Top;
            label7.Left = label6.Left + 280;

            label8.Top = label6.Top;
            label8.Left = label7.Left + 280;

            label9.Top = label6.Top;
            label9.Left = label8.Left + 280;

            label10.Top = label6.Top;
            label10.Left = label9.Left + 280;
